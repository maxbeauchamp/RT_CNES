...
ax.plot(wf0[1:],Pf_OI[1:],'r-',linewidth=.5,label='OI')
ax.plot(wf1[1:],Pf_postAnDA[1:],linestyle='solid',color='seagreen',linewidth=.5,label='post-AnDA')
ax.plot(wf2[1:],Pf_VE_DINEOF[1:],linestyle='solid',color='steelblue',linewidth=.5,label='VE-DINEOF')
ax.plot(wf3[1:],Pf_FP_GENN[1:],linestyle='solid',color='darkorange',linewidth=.5,label='FP-GENN')
