...
ConvAE_nadirswot_file = scratchpath+'/resIA_nadirswot_nadlag_'+NN_lag+"_"+type_obs+'/GB1_ConvAE_womissing_wocov/saved_path_019_ConvAE_womissing.pickle'
GENN_nadir_file       = scratchpath+'/resIA_nadir_nadlag_'+NN_lag+"_"+type_obs+'/GB1_GENN_wmissing_wOI/saved_path_005_GENN_wmissing.pickle'
GENN_nadirswot_file   = scratchpath+'/resIA_nadirswot_nadlag_'+NN_lag+"_"+type_obs+'/GB1_GENN_wmissing_wOI/saved_path_000_GENN_wmissing.pickle'
...
# arguments for plots
labels_data = np.array(['GT','Obs (nadir+swot)','OI (nadir+swot)','Post-AnDA (nadir+swot)','VE-DINEOF (nadir+swot)','Grad-GENN (nadir+swot)'])
list_suffix = np.array(['GT','Obs_nadirswot','OI_nadirswot','Post_AnDA_nadirswot','VE_DINEOF_nadirswot','Grad_GENN_nadirswot'])
