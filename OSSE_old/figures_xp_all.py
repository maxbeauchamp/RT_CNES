...
for i in range(0,len(AnDA_ssh_1.GT)):
    ...
    ax.plot(wf0_nadirswot[1:],Pf_OI_nadirswot[1:],linestyle='dashdot',color='red',linewidth=1.5,label='OI (nadir+swot)')
    ax.plot(wf1_nadir[1:],Pf_AnDA_nadir[1:],linestyle='solid',color='mediumseagreen',linewidth=1.5,label='AnDA (nadir)')
    ax.plot(wf1_nadirswot[1:],Pf_AnDA_nadirswot[1:],linestyle='dashdot',color='mediumseagreen',linewidth=1.5,label='AnDA (nadir+swot)')
    ax.plot(wf2_nadir[1:],Pf_postAnDA_nadir[1:],linestyle='solid',color='seagreen',linewidth=1.5,label='post-AnDA (nadir)')
    ax.plot(wf2_nadirswot[1:],Pf_postAnDA_nadirswot[1:],linestyle='dashdot',color='seagreen',linewidth=1.5,label='post-AnDA (nadir+swot)')
    ax.plot(wf3_nadir[1:],Pf_VE_DINEOF_nadir[1:],linestyle='solid',color='steelblue',linewidth=1.5,label='VE-DINEOF (nadir)')
    ax.plot(wf3_nadirswot[1:],Pf_VE_DINEOF_nadirswot[1:],linestyle='dashdot',color='steelblue',linewidth=1.5,label='VE-DINEOF (nadir+swot)')
    ...
    fig = plt.figure()
    ax = fig.add_subplot(111)
    ax.plot(wf0_nadirswot[1:],Pf_OI_nadirswot[1:],linestyle='solid',color='red',linewidth=1.5,label='OI (nadir+swot)')
    ax.plot(wf1_nadirswot[1:],Pf_AnDA_nadirswot[1:],linestyle='solid',color='mediumseagreen',linewidth=1.5,label='AnDA (nadirswot)')
    ax.plot(wf2_nadirswot[1:],Pf_postAnDA_nadirswot[1:],linestyle='solid',color='seagreen',linewidth=1.5,label='post-AnDA (nadirswot)')
...
tab_scores[2,0] = np.nanmean(nrmse_Post_AnDA_nadir[index])
tab_scores[2,1] = np.percentile(nrmse_Post_AnDA_nadir[index],5)
tab_scores[2,2] = np.percentile(nrmse_Post_AnDA_nadir[index],95)
tab_scores[1,0] = np.nanmean(nrmse_VE_DINEOF_nadir[index])
tab_scores[1,1] = np.percentile(nrmse_VE_DINEOF_nadir[index],5)
tab_scores[1,2] = np.percentile(nrmse_VE_DINEOF_nadir[index],95)
tab_scores[3,0] = np.nanmean(nrmse_FP_ConvAE_nadir[index])
tab_scores[3,1] = np.percentile(nrmse_FP_ConvAE_nadir[index],5)
tab_scores[3,2] = np.percentile(nrmse_FP_ConvAE_nadir[index],95)
...
tab_scores[1,0] = np.nanmean(nrmse_Grad_Post_AnDA_nadir[index])
tab_scores[1,1] = np.percentile(nrmse_Grad_Post_AnDA_nadir[index],5)
tab_scores[1,2] = np.percentile(nrmse_Grad_Post_AnDA_nadir[index],95)
tab_scores[2,0] = np.nanmean(nrmse_Grad_VE_DINEOF_nadir[index])
tab_scores[2,1] = np.percentile(nrmse_Grad_VE_DINEOF_nadir[index],5)
tab_scores[2,2] = np.percentile(nrmse_Grad_VE_DINEOF_nadir[index],95)
tab_scores[3,0] = np.nanmean(nrmse_Grad_FP_ConvAE_nadir[index])
tab_scores[3,1] = np.percentile(nrmse_Grad_FP_ConvAE_nadir[index],5)
tab_scores[3,2] = np.percentile(nrmse_Grad_FP_ConvAE_nadir[index],95)
...
ax.plot(wf_ref[1:],Pf_GT[1:],label='GT')
ax.plot(wf0_nadirswot[1:],Pf_OI_nadirswot[1:],linestyle='solid',color='red',linewidth=1.5,label='OI (nadir+swot)')
ax.plot(wf1_nadirswot[1:],Pf_AnDA_nadirswot[1:],linestyle='solid',color='mediumseagreen',linewidth=1.5,label='AnDA (nadir+swot)')
ax.plot(wf2_nadirswot[1:],Pf_postAnDA_nadirswot[1:],linestyle='solid',color='seagreen',linewidth=1.5,label='post-AnDA (nadir+swot)')
