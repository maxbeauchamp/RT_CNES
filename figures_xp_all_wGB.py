...
file_results_nadir=scratchpath+'/resIA_nadir_nadlag_'+NN_lag+"_"+type_obs+'/GB_GENN_wmissing_wOI/saved_path_019_GB_GENN_wmissing.pickle'
with open(file_results_nadir, 'rb') as handle:
    itrp_GB_GENN_nadir, rec_GB_GENN_nadir = pickle.load(handle)[2:]
file_results_nadirswot=scratchpath+'/resIA_nadirswot_nadlag_'+NN_lag+"_"+type_obs+'/GB_GENN_wmissing_wOI/saved_path_019_GB_GENN_wmissing.pickle'
with open(file_results_nadirswot, 'rb') as handle:
    itrp_GB_GENN_nadirswot, rec_GB_GENN_nadirswot = pickle.load(handle)[2:]
...
for i in range(0,len(AnDA_ssh_1.GT)):
    ...
    ax.plot(wf6_nadir[1:],Pf_GB_GENN_nadir[1:],linestyle='solid',color='navy',linewidth=.5,label='GB-GENN (nadir)')
    ax.plot(wf6_nadirswot[1:],Pf_GB_GENN_nadirswot[1:],linestyle='dashdot',color='navy',linewidth=.5,label='GB-GENN (nadir+swot)')
    ...
    ax.plot(wf6_nadirswot[1:],Pf_GB_GENN_nadirswot[1:],linestyle='solid',color='navy',linewidth=.5,label='GB-GENN (nadirswot)')
    ax.set_xlabel("Wavenumber", fontweight='bold')
    ax.set_ylabel("Power spectral density (m2/(cy/km))", fontweight='bold')
    ax.set_xscale('log') ; ax.set_yscale('log')
    plt.legend(loc='best',prop=dict(size='small'),frameon=False)
...
ax.plot(wf6_nadirswot[1:],Pf_GB_GENN_nadirswot[1:],linestyle='solid',color='navy',linewidth=.5,label='GB-GENN (nadir+swot)')
ax.set_xlabel("Wavenumber", fontweight='bold')
ax.set_ylabel("Power spectral density (m2/(cy/km))", fontweight='bold')
ax.set_xscale('log') ; ax.set_yscale('log')
plt.legend(loc='best',prop=dict(size='small'),frameon=False)
